...
The appearance of Balmer's formula triggered a systematic search for spectral regularities. In 1888, the Swedish physicist Johannes Robert Rydberg (1854--1919), after an in-depth study of the spectral data of many elements, generalized Balmer's formula into a far more universal form. Rydberg realized that the 4 in Balmer's $n^2 - 4$ was simply $2^2$, and that 2 was merely a special value of a more general parameter. He rewrote the formula in terms of the wavenumber (the reciprocal of wavelength):
