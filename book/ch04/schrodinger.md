...
1. 薛定谔方程是如何被"发现"的？薛定谔本人是从什么物理直觉出发的？这个方程能被"推导"出来吗？

2. 为什么薛定谔方程是线性方程？这与叠加原理有什么关系？如果方程是非线性的，量子力学会变成什么样？

3. 薛定谔方程中的波函数是复数，但薛定谔最初希望波函数代表某种"真实的波"。玻恩的概率解释为什么最终胜出？

4. 经典力学中基态能量可以为零，但量子力学中基态能量(零点能)不为零。这有什么物理后果？零点能是"真实"的吗？
